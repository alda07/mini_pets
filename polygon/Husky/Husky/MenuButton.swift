...
internal class MenuButton: UIButton {
    ...
    init(size: CGSize, circleMenu: Menu, distance: Float, angle: Float = 0) {
    ...
    private func createContainer(size: CGSize, circleMenu: Menu) -> UIView {
