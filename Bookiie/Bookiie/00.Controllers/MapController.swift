...
class MapController: UIViewController, UISearchBarDelegate, LocateOnTheMap {
    
    let cllocationManager: CLLocationManager = CLLocationManager()
    
    @IBOutlet weak var mapViewContainer: UIView!
    @IBOutlet weak var searchBtn: UIBarButtonItem!
    @IBOutlet weak var xbarItem: UIBarButtonItem!
    ...
    var searchResultsTable: SearchResultsController!
    ...
    override func viewDidLoad() {
        ...
        if CLLocationManager.locationServicesEnabled() {
            ...
            self.searchBtn.tintColor = SalmonTheme
        }
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        // searchResultsTable
        searchResultsTable = SearchResultsController()
        searchResultsTable.delegate = self
        
        // xbarItem
        xbarItem.tintColor = SalmonTheme
    ...
    func performAnimation(){
        UINavigationBar.animateWithDuration(1, delay: 0.5, options: .Repeat, animations: {
    ...
    @IBAction func xBarItemAddress(sender: AnyObject) {
...
extension MapController: GMSAutocompleteFetcherDelegate {
